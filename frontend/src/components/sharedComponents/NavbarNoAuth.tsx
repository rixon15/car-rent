    ...
    return (
        <nav className="">
            ...
            <div className="flex flex-row items-center">
                <div
                    className="border-blue-600 focus-within:border-none focus-within:ring focus-within:ring-offset-2 my-10  h-10 items-center justify-start border-2 leading-4 ring-blue-600 rounded-full md:hidden flex w-full">
                    <input
                        placeholder="Search"
                        value=""
