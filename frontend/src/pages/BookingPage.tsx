        ...
        return (
            <>
                ...
                <div className="container mx-auto">
                    ...
                    {/* Billing info */}
                    <div className="grid grid-cols-1 sm:grid-cols-2 grid-rows-4 sm:grid-rows-3 gap-4 mt-8">
                        ...
                        <div className="sm:row-span-4 sm:col-start-2  row-start-1 w-full sm:max-w-[500px] ">
                            <div className="bg-[#FFFFFF] p-6 rounded-xl  h-full sm:h-1/4 min-h-[550px]">
                                <div className="flex flex-col gap-y-8 h-full ">
                                    ...
                                    <div
                                        className="flex flex-row items-center rounded-lg gap-x-8 gap-y-4 relative h-14">
                                        <input
                                            type="text"
