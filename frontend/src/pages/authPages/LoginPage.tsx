...
const LoginPage = () => {
    ...
    return (
        <div className="bg-slate-300 w-screen font-sans text-gray-900 min-h-svh">
            ...
            <div className=" ">
                <div
                    className="mx-auto w-full sm:max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl">
            ...
            <div
                className="md:w-2/3 mx-auto w-full pb-16 sm:max-w-screen-sm md:max-w-screen-md lg:w-1/3 lg:max-w-screen-lg xl:max-w-screen-xl ">
                <form
                ...
                >
                    ...
                    <div className="flex flex-row-reverse items-center justify-between text-sm font-bold text-blue-500 mb-6">
                        ...
                        <div className="flex flex-col items-start justify-start">
                            <Link to={"/"}>Home</Link>
                            <p className='text-black'>Username: demo@demo.com</p>
                            <p className='text-black'>Password: 123456</p>
                        </div>
